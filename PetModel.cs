...
namespace CSHARPCRUDMVC.Models
{
    public class PetModel
    {
        ...
        [Required(ErrorMessage ="Pet name is requirid")]
        ...
        [Required(ErrorMessage = "Pet type is requirid")]
        ...
        [Required(ErrorMessage = "Pet colour is requirid")]
